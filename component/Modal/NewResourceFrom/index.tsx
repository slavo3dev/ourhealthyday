...
export const NewResourceFrom: FC<NewResourceFromProps> = ({
  setSources,
  setShowForm,
}) => {
    ...
    <>
      ...
      <div className="flex fixed inset-0 z-10 overflow-y-auto items-center justify-center">
        {isUploading && (
          ...
          >
            Thank You so much for sharing this with the Comunity
          </h3>
        )}
        <div className="w-full max-w-lg bg-gray-300 p-9 shadow-lg shadow-gray-100 transition-all rounded-lg sm:my-8 sm:w-full sm:max-w-lg">
            ...
            <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
              ...
              {source.length === 0 || !isValidHttpUrl(source) ? (
                <p className="text-red-500 text-xs italic">
                  Please fill out this field or Add proper URL.
                </p>
              ) : (
                ""
              )}
          ...
          <div className="flex flex-wrap -mx-3 mb-6">
            <div className="w-full px-3">
              ...
              <p className="text-gray-600 text-xs italic">
                You Have 250 words to describe your source - You are
                helping Comunity -{" "}
              </p>
            </div>
          </div>
          <div className="itmes-center content-center w-full">
            <button
              className="bg-gray-500 hover:bg-gray-900 text-white w-1/3 font-bold py-2 px-4 border border-red-700 rounded"
              disabled={isUploading}
            ...
            <button
              className="bg-red-100 hover:bg-gray-900 w-1/3 font-bold py-2 px-4 border border-red-300 rounded float-right"

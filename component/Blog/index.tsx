...
export const Blog: FC<IBlogProps> = () => {
  return (
    <section className="py-6 sm:py-12 bg-emerald dark:text-gray-100 blog-section">
    <div className="container p-6 mx-auto space-y-8">
      <div className="space-y-2 text-center">
        <h2 className="text-3xl font-bold text-amber-950">Partem reprimique an pro</h2>
        <p className="font-serif text-sm dark:text-amber-950">Qualisque erroribus usu at, duo te agam soluta mucius.</p>
      </div>

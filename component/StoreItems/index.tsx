      ...
      <section className="py-20 pt-20">
        <div className="store">
          ...
          <div className="grid grid-flow-col auto mt-10-cols-auto mt-10 ml-5 py-16 pt-20 pb-0 store-items">
            ...
            <div className="mr-6">
              <Image
                className="h-full border-2 border-teal-500 rounded-lg"
                src="https://cdn.outsideonline.com/wp-content/uploads/2022/10/popadelics-rosemary-chips_h.jpg?width=730"
                alt={""}
                width={730}
                height={320}
              />
        ...
        <div className="store">
          ...
          <div className="grid grid-flow-col auto mt-10-cols-auto mt-10 ml-5 py-16 pt-20 pb-0 store-items">
            ...
            <div className="mr-6">
              <Image
                className="h-full border-2 border-teal-500 rounded-lg"
                src="https://cdn.outsideonline.com/wp-content/uploads/2022/10/confetti-mushroom-chips_h.jpg?width=730"
                alt={""}
                width={730}
                height={320}
              />
        ...
        <div className="store">
          ...
          <div className="grid grid-flow-col auto mt-10-cols-auto mt-10 ml-5 py-16 pt-20 pb-0 store-items">
            ...
            <div className="mr-6">
              <Image
                className="h-full border-2 border-teal-500 rounded-lg"
                src="https://cdn.outsideonline.com/wp-content/uploads/2022/10/somos-smoky-chipotle_h.jpg?width=730"
                alt={""}
                width={730}
                height={320}
              />
        ...
        <div className="store">
          ...
          <div className="grid grid-flow-col auto mt-10-cols-auto mt-10 ml-5 py-16 pt-20 pb-0 store-items">
            ...
            <div className="mr-6">
              <Image
                className="h-full border-2 border-teal-500 rounded-lg"
                src="https://cdn.outsideonline.com/wp-content/uploads/2022/10/laird-hot-chocolate-mushrooms_h.jpg?width=730"
                alt={""}
                width={730}
                height={320}
              />

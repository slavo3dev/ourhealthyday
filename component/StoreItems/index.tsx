	...
	return (
		<>
			<section className="py-20 pt-20">
				<div className="store">
					<div className="mt-3">
						<h1 className="text-center cursor-pointer py-1.5 text-black text-4xl font-semibold">
              Popadelics Crunchy Mushroom Chips ($30 for three bags)
						</h1>
					</div>
					<div className="grid grid-flow-col auto mt-10-cols-auto mt-10 ml-5 py-16 pt-20 pb-0 store-items">
						<div className="bg-white rounded-lg border-solid border-2 border-teal-500 ... shadow-2xl text-xl font-serif mr-5">
                ...
                organizations.
						...
						<div className="mr-6">
							<img className="h-full border-2 border-teal-500 rounded-lg" src="https://cdn.outsideonline.com/wp-content/uploads/2022/10/popadelics-rosemary-chips_h.jpg?width=730" />
						</div>
					</div>
					<div className="grid grid-flow-col auto mt-10-cols-auto arrow-block">
						<button className="hover:font-bold bg-white text-black border-2 border-teal-500 rounded-lg shadow py-2 px-4 ml-5 md:ml-80 font-serif w-40 md:w-60 mt-10">
              ...
              Confetti Snacks Mushroom Chips ($6 per pack){" "}
					...
					<div className="grid grid-flow-col auto mt-10-cols-auto mt-10 ml-5 py-16 pt-20 pb-0 store-items">
						<div className="bg-white rounded-lg border-solid border-2 border-teal-500 ... shadow-2x. text-xl font-serif mr-5">
							<p className="px-5 md:px-20 py-5 md:py-20">
                ...
                and Sea Salt in the future.
						...
						<div className="mr-6">
							<img className="h-full border-2 border-teal-500 rounded-lg" src="https://cdn.outsideonline.com/wp-content/uploads/2022/10/confetti-mushroom-chips_h.jpg?width=730" />
						</div>
					</div>
					<div className="grid grid-flow-col auto mt-10-cols-auto arrow-block">
						<button className="hover:font-bold bg-white text-black border-2 border-teal-500 rounded-lg shadow py-2 px-4 ml-5 md:ml-80 font-serif w-40 md:w-60 mt-10">
              ...
              Somos Smoky Chipotle Mushrooms ($11 for two pouches){" "}
                ...
                burritos for a hearty meal.
						...
						<div className="mr-6">
							<img className="h-full border-2 border-teal-500 rounded-lg" src="https://cdn.outsideonline.com/wp-content/uploads/2022/10/somos-smoky-chipotle_h.jpg?width=730" />
						</div>
					</div>
					<div className="grid grid-flow-col auto mt-10-cols-auto arrow-block">
						<button className="hover:font-bold bg-white text-black border-2 border-teal-500 rounded-lg shadow py-2 px-4 ml-5 md:ml-80 font-serif w-40 md:w-60 mt-10">
              ...
              ($25 per bag){" "}
                ...
                ounces of hot water or milk for a soothing beverage.
						...
						<div className="mr-6">
							<img className="h-full border-2 border-teal-500 rounded-lg" src="https://cdn.outsideonline.com/wp-content/uploads/2022/10/laird-hot-chocolate-mushrooms_h.jpg?width=730" />
						</div>
					</div>
					<div className="grid grid-flow-col auto mt-10-cols-auto arrow-block">
						<button className="hover:font-bold bg-white text-black border-2 border-teal-500 rounded-lg shadow py-2 px-4 ml-5 md:ml-80 font-serif w-40 md:w-60 mt-10">

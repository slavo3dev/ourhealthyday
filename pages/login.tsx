...
const LoginForm: FC = () => {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    // You can perform login logic here, e.g., API call or validation checks.
    ...
    <>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8">
          <div className="">
            <img src="https://www.pngkit.com/png/detail/808-8088160_loginsignupwishlist-transparent-login-icon.png"></img>
          </div>
          <div>
